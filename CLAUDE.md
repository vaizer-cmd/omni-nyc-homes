...
**Key copy**: Home hero — "Your Building, Perfectly Managed. Your Tenants, always in the Loop."; tagline "Built on Trust, Driven by Excellence." Company is "OMNI Management LLC", founded by NYC real-estate veterans, serving all five boroughs. About/Contact/Services/Industry Expertise hero boxes are short — just the gold eyebrow label, no H1 (matches About's original style).
